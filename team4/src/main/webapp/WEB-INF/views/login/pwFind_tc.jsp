        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              	...
              	<form class="pt-3" action="pwFind_tc" method="post" onsubmit="return formCheck()">
              	<table align="center">
					<tr class="form-group">
						<td><input type="text" id="id" name="tc_id" value="${teacher.tc_id }" class="form-control form-control-lg" placeholder="아이디"></td>
					</tr>
					<tr class="form-group">
						<td><input type="text" id="name" name="tc_name" value="${teacher.tc_name }" class="form-control form-control-lg" placeholder="이름"></td>
					</tr>
					<tr class="form-group">
						<td><input type="text" id="dob" name="tc_dob" value="${teacher.tc_dob }" class="form-control form-control-lg" placeholder="생년월일"></td>
					</tr>
					<tr class="form-group">
						<td><input type="email" id="email" name="tc_email" value="${teacher.tc_email }" class="form-control form-control-lg" placeholder="이메일"></td>
					</tr>
					<tr class="mt-3">
