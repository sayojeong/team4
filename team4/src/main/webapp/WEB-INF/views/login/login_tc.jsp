          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
            	<h1 align="center">YA<span id="yyYoungColor">YOUNG</span></h1>
              	<h5 align="center">강사 로그인</h5>
              <form class="pt-3" action="login_tc" method="post" onsubmit="return formCheck()">
              	<table align="center">
					<tr class="form-group">
						<td><input type="text" id="id" name="tc_id" class="form-control form-control-lg" placeholder="아이디"></td>
					</tr>
					<tr class="form-group">
						<td><input type="password" class="form-control form-control-lg" id="pw" name="tc_pw" placeholder="비밀번호"></td>
					</tr>
					<tr class="mt-3">
					...
					<tr class="my-2 d-flex justify-content-between align-items-center">
						...
						<th><input type="button" id="pwFind" class="btn btn-block btn-inverse-success auth-form-btn" onclick="toPw()" value="비번 찾기"></th>
					</tr>
				</table>
              </form>
            </div>
