...
<form action="noteUpdate" method="post">
	<input type="hidden" value="${vo.note_num}" name="note_num">
	...
	<br>
	<textarea id="note" name="note_content">${vo.note_content}</textarea>
	<input type="submit" class="btn alazea-btn w-5" id="add" value="노트저장">
	<input type="button" class="btn alazea-btn w-5" value="노트삭제" onclick="location.href='deleteNote?note_num=${vo.note_num}'">
</form>
</body>
</html>