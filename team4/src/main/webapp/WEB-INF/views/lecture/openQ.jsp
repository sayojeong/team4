...
<form action="updateTWA" method="post" onsubmit="return submitWA()">
	...
	<div class="col-12 col-lg-5">
         ...
         <div class="section-heading">
             <h2 id="yyStdId">${sw.st_id} 님의 답</h2>
         </div>
         <!-- Contact Form Area -->
                 ...
                 <div class="row">
                     <div class="col-12">
                         <div class="form-group">
                         	 <h6>문제</h6>
                             <pre><textarea class="form-control" id="message" cols="30" rows="10" style="resize: none;">${sw.w_question}</textarea></pre>
                         </div>
                     </div>
                     <div class="col-12">
                         <div class="form-group">
                         	 <h6>답</h6>
                             <pre><textarea class="form-control"  id="message" cols="30" rows="10" style="resize: none;">${sw.wa_stans}</textarea></pre>
                         </div>
                     </div>
                     <div class="col-12">
                         <div class="form-group">
                             ...
                             <c:if test="${sw.wa_tcomment != null}">
                             	<pre><textarea class="form-control" id="wa_tcomment" name="wa_tcomment" cols="30" rows="10" style="resize: none;">${sw.wa_tcomment}</textarea></pre>
                             </c:if>
							<c:if test="${sw.wa_tcomment == null}">
								<pre><textarea class="form-control" id="wa_tcomment" name="wa_tcomment" cols="30" rows="10" style="resize: none;">선생님의 답 대기중..</textarea></pre>
							</c:if>
                         </div>
                     </div>
                 </div>
