...
<head>
    ...
    <script>
	    function  goHW(num){
	 	   ...
	 	   var name = "hw";
	 	   var option = "width = 1300, height = 700, top = 0, left = 200, location = no"
            ...
            <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                  		<div class="checkout-btn">
                           					<a href="javascript: goHW(${list.ins_num})" class="btn alazea-btn w-100">과제 등록 하기</a>
                        				</div>
                                    </td>
                                </tr>
                                </c:forEach>
                ...
                <!-- ##### 페이징 ##### -->
		         <nav aria-label="Page navigation" id="yyPagenavi">
		             <ul class="pagination">
		                 <li class="page-item"><a class="page-link" href="${path}/lecture/insertHW?page=${navi.currentPage - 1}"><i class="fa fa-angle-left"></i></a></li>
		                 <c:forEach var="counter" begin="${navi.startPageGroup}" end="${navi.endPageGroup}"> 
							<c:if test="${counter == navi.currentPage}"><b></c:if>
				                 <li class="page-item"><a class="page-link" href="${path}/lecture/insertHW?page=${counter}">${counter}</a></li>
							<c:if test="${counter == navi.currentPage}"></b></c:if>
						</c:forEach>
		                 <li class="page-item"><a class="page-link" href="${path}/lecture/insertHW?page=${navi.currentPage + 1}"><i class="fa fa-angle-right"></i></a></li>
		             </ul>
		         </nav>
		         <!-- ##### 페이징 ##### -->
             </div>
